...
export default function GradientWaves({
  ...
  // Keep enableMouseRef synchronized with latest prop
  ...
  useEffect(() => {
    ...
    // Clean any prior canvas children before attaching (strict mode safety)
    ...
    // Pointer move listener that listens to window to support pointer-events: none wrappers
    const onPointerMove = (e: MouseEvent | PointerEvent) => {
      ...
      targetMouse[0] = Math.max(0, Math.min(1, rawX));
      targetMouse[1] = Math.max(0, Math.min(1, rawY));
    };
